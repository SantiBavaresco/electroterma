...
const updateImage = (index) => {
    ...
    (window.innerWidth <= 768 ) ?
        ...
        context?.drawImage(imgArray[index], 0, 0, 400, 711, 0, 50, canvas.width, canvas.height)
        : context?.drawImage(imgArray[index], 0, 0, 400, 711, 0, 0, canvas.width, canvas.height)
