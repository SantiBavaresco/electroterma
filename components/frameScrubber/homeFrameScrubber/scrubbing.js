...
const updateImage = (index) => {
    ...
    (window.innerWidth <= 768 ) ?
        context?.drawImage(imgArray[index], 0, 0, 480, 880, 0, 10, canvas.width, canvas.height)
        : context?.drawImage(imgArray[index], 0, 0, 900, 563, 0, 0, canvas.width, canvas.height)
