...
let frameCount = 600;
  if (ventElement) {    
    ...
    if(keyAttribute === "uta") frameCount = 150
...
const currentFrame = (index) => `../img/videos/frames uta/3/${index.toString()}.webp`;
...
window.addEventListener("scroll", () => {
    ...
    const scrollTop = html.scrollTop - ((window.innerWidth <= 768) ? 380 : 5300);
