...
let frameCount = 600;
  if (ventElement) {    
    ...
    if(keyAttribute === "uta") frameCount = 158
...
const currentFrame = (index) => `../img/videos/frames uta/6/${index.toString()}.webp`;
...
window.addEventListener("scroll", () => {
    ...
    const scrollTop = html.scrollTop - ((window.innerWidth <= 768) ? 3380 : 12000);
