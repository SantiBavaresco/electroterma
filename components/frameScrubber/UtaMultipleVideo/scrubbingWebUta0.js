...
const canvas = document.getElementById("hero-lightpass0");
...
let frameCount = 600;
  if (ventElement) {    
    ...
    if(keyAttribute === "uta") frameCount = 152
...
const currentFrame = (index) => `../img/videos/frames uta/1/${index.toString()}.webp`;
...
window.addEventListener("scroll", () => {
    ...
    const scrollTop = html.scrollTop - ((window.innerWidth <= 768) ? 0 : 0);
