...
export default function FrameScrubberWebUta() {
    ...
    useEffect(() => {
        require("./scrubbingWebUta0");
        return () => {};
    }, []);

    return (
        <div className="" id="frame0" ref={frameRef}>
            <section class="frames0 flex flex-col ">
                {/* <div className="z-10 w-1/2 flex flex-row justify-around mx-auto -translate-x-10 translate-y-0 bottom-20  bg-blue-500">
                    <span>
                        <h1> Seccion 1</h1>
                        <h1> Seccion 1</h1>
                        </span>
                ...
                <div class="holder">
                    <canvas id="hero-lightpass0" className="mb- 16" />
                </div>
