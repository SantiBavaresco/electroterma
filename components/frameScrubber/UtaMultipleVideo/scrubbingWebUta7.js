...
const canvas = document.getElementById("hero-lightpass7");
...
let frameCount = 600;
  if (ventElement) {    
    ...
    if(keyAttribute === "uta") frameCount = 182
...
const currentFrame = (index) => `../img/videos/frames uta/8/${index.toString()}.webp`;
...
window.addEventListener("scroll", () => {
    ...
    const scrollTop = html.scrollTop - ((window.innerWidth <= 768) ? 3380 : 22800);
