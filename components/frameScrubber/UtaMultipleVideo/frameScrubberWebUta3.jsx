...
export default function FrameScrubberWebUta3() {
    ...
    useEffect(() => {
        require("./scrubbingWebUta3");
        return () => {};
    }, []);

    return (
        <div className="" id="frame3" ref={frameRef}>
            <section class="frames3 flex flex-col ">
                <div className="z-10 w-1/2 flex flex-row justify-around mx-auto -translate-x-10 translate-y-0 bottom-20  bg-green-500">
                    <span>
                        <h1> Seccion 3</h1>
                        <h1> Seccion 3</h1>
                    </span>
                ...
                <div class="holder">
                    <canvas id="hero-lightpass3" className="mb-16" />
                </div>
