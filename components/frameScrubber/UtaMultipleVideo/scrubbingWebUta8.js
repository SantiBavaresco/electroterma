...
const canvas = document.getElementById("hero-lightpass8");
...
let frameCount = 600;
  if (ventElement) {    
    ...
    if(keyAttribute === "uta") frameCount = 62
...
const currentFrame = (index) => `../img/videos/frames uta/9/${index.toString()}.webp`;
...
window.addEventListener("scroll", () => {
    ...
    const scrollTop = html.scrollTop - ((window.innerWidth <= 768) ? 3380 : 27600);
