...
import { ElementosOpcionales } from "@/public/svg/elementosOpcionales";
...
export const DiferencialElementosOpcionales : React.FC<Props> =  ({size, text, textSize, customWith}) => {
	return (
		<>
			<main className="relative pl-4 flex justify-start items-center  w-full">
				<span className=" z-10">

				<ElementosOpcionales size={size || 70}/>
				...
				<p className={`z-0   h-2/3 pl-8 pr-1 md:px-10 py-1 -translate-x-8 
					...
					<span className="w-full pl-1 py-0 flex justify-start items-center">{text || "Elementos opcionales"}</span>
				</p>
