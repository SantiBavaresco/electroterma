        ...
        bg-[center_top_20vw] bg-no-repeat overflow-hidden">
            ...
            <section className="relative w-full px-[3%] mt-20 mb-20 text-center font-lexend text-[1.6vw] overflow-hidden text-[#787878]">
                <p>
                    ...
                    <span className="">TEMPOMATIC es nuestra línea de productos HVAC, estándar y </span><br/>
                    ...
                    <div className="absolute bottom-0 right-[36.5%] lg:right-[27.5%] xl:right-[28.5%] 2xl:right-[35.5%]">
