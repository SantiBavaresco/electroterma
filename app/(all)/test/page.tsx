			...
			<section className="relative w-full h-[22vw] bg-gray-100 ">
				...
				<span className="flex flex-4 items-center justify-center w-[80%] mt-[0vw] h-full gap-[1vw] mx-auto">
					<div
						...
						hover:translate-x-[-4px] hover:translate-y-[-4px] hover:rounded-tr-[4.9vw] hover:rounded-bl-[4.9vw] hover:shadow-[4px_4px_0px_orange] active:translate-x-[0px] active:translate-y-[0px] active:rounded-2xl active:shadow-none
						" 
					...
					<div
						...
						transition-all duration-300 hover:translate-x-[-4px] hover:translate-y-[-4px] hover:rounded-br-[4.9vw] hover:shadow-[4px_4px_0px_orange] active:translate-x-[0px] active:translate-y-[0px] active:rounded-2xl active:shadow-none
						"  
					// className="absolute w-[30%] top-[20%]  -right-[5vw]"
					>
						<Image  
					...
					<div
						// className="w-[13.5vw]"
						className="w-1/6 relative opacity-70 hover:opacity-100
						transition-all duration-300 hover:translate-x-[-4px] hover:translate-y-[-4px] hover:rounded-tr-[4.6vw] hover:rounded-bl-[4.5vw] hover:shadow-[4px_4px_0px_orange] active:translate-x-[0px] active:translate-y-[0px] active:rounded-2xl active:shadow-none
						"    
					// className="absolute w-[30%] top-[20%]  -right-[5vw]"
					>
						<Image  
