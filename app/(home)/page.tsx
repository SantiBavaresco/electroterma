                ...
                <div className="mx-[3%] flex flex-row items-center justify-center gap-[2%] ">
                    ...
                    <a href="https://wa.me/5492236356756?text=Hola,%20visite%20tu%20pagina%20web%20y%20me%20gustaria%20mas%20informacion." 
                        className=""
                            ...
                            <a href="https://www.tiendaelectroterma.com.ar/" 
                                target="_blank" rel="noopener noreferrer">
                            <MyButton
                                className="z-10 mt-4 bg-[#EDEDED] font-nunito text-[#4C4B4B] 3xl:ml-0 2xl:text-2xl"
                                radius="full"
                            ...
                            >
                                ...
                                <div className="absolute rounded-full left-0 z-20 p-3   shadow-r-xl shadow-[rgba(29,29,27,0.24)] border- border-gray-200 
                                    ...
                                    group-active:bg-gradient-to-r group-active:from-[#f37a7ae5] group-active:to-[#FFFFFF]
                                "> 
                                    <ShoppingCart size={BigScreen ? 40 : 25} css="group-active:text-livered p- mx-0 lg:mx-1 lg:text-2xl"/>
                                     </div>
                                <span className="ml-[35px] lg:ml-14">Tienda Online</span>
                            </MyButton>
                            </a>
                            ...
                            >
                                ...
                                <span className="ml-[35px] lg:ml-12">Escribinos</span>
                            </MyButton>
