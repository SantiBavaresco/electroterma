...
export default function Home() {
    ...
    return (
        <main id="vent" accessKey="home" className="flex flex-col items-center justify-center gap-4 pb-0 md:pb-0 ">
           ...
           {!BigScreen || <section className="relative w-full px-[3%] my-10 pt-4 text-center font-lexend text-[#4C4B4B] text-[1.75vw] overflow-hidden">
                <p>
                    {/* <span className="relative  align-bottom text-livered-title ">&quot;</span> */}
                    <div className="z-20 absolute -top-[22%] left-[23%] lg:left-[24%] xl:left-[25%] 2xl:left-[23.5%]">
                        <Image  
                            className=" mt-0"
                            alt="Background Tempomatic"
                            radius="none"
