                    ...
                    <Card isBlurred>
                        <CardBody>
                            <p>
                                ...
                                (motor acople directo) ha sido desarrollada para
                                dar solución a necesidades de ventilación
                                general de aire limpio y donde se requieren
                                niveles medios de contrapresión.
                                <br /> <br />
                                Son equipos de alto rendimiento energético,
                                de&nbsp;
                                <a className="text-orange-500 font-semibold">
                                    excelente calidad constructiva
                                </a>{" "}
                                y balanceados estática y dinámicamente.
                                Fabricados íntegramente en chapa galvanizada,
                                con turbinas de aluminio y chapa de acero al
                                carbono.
                            </p>
                        </CardBody>
                    </Card>
                    ...
                    <Card>
                        <CardBody>
                            <p>
                                ...
                                son utilizados como sistemas de inyección y
                                extracción de aire limpio para:
                            </p>
                            ...
                            <ul className="pl-4 pt-2 font-bold">
                                <ol className="flex items-center pl-2">
                                    <DotSVG color="#f97316" />
                                    <p className="pl-2">
                                        Presurización escaleras evacuación
                                        incendio
                                    </p>
                                </ol>
                                <ol className="flex items-center pl-2">
