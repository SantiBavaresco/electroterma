...
const itemClasses = {
    ...
    return (
        <main  className="h-full flex flex-col items-center justify-center">
            ...
            <section className="flex flex-col md:mt-4 md:flex md:flex-row justify-between w-3/4 ">
                <div className="ml-10">
                    <div className="flex flex-col -mt-10 gap-1 text-start justify-items-end items-start font-lexend-bold tracking-widest ">
